...
<template>
    <main
        class="min-h-screen bg-gradient-to-b from-sky-50 to-white flex flex-col items-center py-12"
    >
        <div
            class="w-full max-w-2xl bg-white shadow-xl rounded-2xl p-8 border border-slate-100"
        >
            <div class="mb-10 pb-4 border-b border-sky-100">
                <h1
                    class="text-4xl font-extrabold text-sky-700 flex items-center justify-center gap-3"
                >
