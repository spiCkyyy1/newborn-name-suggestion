<template>
    <main
        class="min-h-screen bg-gradient-to-b from-sky-50 to-white flex items-center justify-center py-16 px-4"
    >
        <div
            class="w-full max-w-lg bg-white p-10 rounded-3xl shadow-xl border border-slate-100"
        >
            <!-- Header -->
            <h1 class="text-4xl font-extrabold text-sky-700 mb-8 text-center">
                Contact Us
            </h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div
                    v-if="form.progress"
                    class="mt-2 h-2 w-full bg-slate-200 rounded-full overflow-hidden"
                >
                    <div
